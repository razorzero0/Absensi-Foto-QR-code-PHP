...
<form action="/daily_absensi" method="post">
  @csrf
  @if($filter)
...
<div class="container table-responsive py-3 "> 
      ...
      <tbody>
       ...
       <?php
        ...
        @if($d->masuk == 0)
          ...
          @elseif($d->status == "belum absen masuk")
          <td  class="d-flex justify-content-center "><button class=" d-flex px-4  btn btn-warning "> tes Schedule harian</button></td>
          @else
    ...
    <form action="/hapus" > 
      ...
      <button class="btn btn-danger" type="submit" onclick="return confirm('Yakin Hapus Semua Data?');"> Hapus Semua</button>
